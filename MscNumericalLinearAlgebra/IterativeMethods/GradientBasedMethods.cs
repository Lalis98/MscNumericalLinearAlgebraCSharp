...
{
    public static class GradientBasedMethods
    {
        public static double[] GradientDescent(double[,] matrixA, double[] vectorB, double epsilon, int maxIterations = 100)
        {
        ...
        public static double[] ConjugateGradient(double[,] matrixA, double[] vectorB, double epsilon, int maxIterations = 100)
        {
